...
echo "  ✅ Target group selection"  
echo "  ✅ Message configuration"
echo "  ✅ Rate limit settings"
echo "  ✅ Everything you need!"
echo ""
echo "Or if you prefer manual setup:"
echo "  1. Edit .env with API_ID, API_HASH, PHONE_NUMBER"
echo "  2. Edit config.json with your messages"
echo "  3. Run: python3 test_bot.py (verify setup)"
echo "  4. Run: python3 userbot.py (start bot)"
echo ""
