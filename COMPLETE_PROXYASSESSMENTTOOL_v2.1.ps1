# ProxyAssessmentTool v2.1.0 - Updated Version
# This version will be detected by the update system

param(
    [string]$OutputPath = "ProxyAssessmentTool_v2.1.exe"
)

Write-Host "=== Building ProxyAssessmentTool v2.1.0 ===" -ForegroundColor Cyan
Write-Host "This is the newer version that will trigger updates!" -ForegroundColor Green
...
try {
    # Generate the complete C# application with v2.1.0
    $mainCode = @'
using System;
...
namespace ProxyAssessmentTool
{
    ...
    public class DashboardView : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            versionLabel.Text = "Version 2.1.0 - Now with enhanced features!";
...
'@
    ...
    if (Test-Path $OutputPath) {
        Write-Host "SUCCESS! ProxyAssessmentTool v2.1.0 compiled to: $OutputPath" -ForegroundColor Green
        Write-Host ""
        Write-Host "WHAT'S NEW IN v2.1.0:" -ForegroundColor Cyan
        Write-Host "✓ Version number updated to 2.1.0" -ForegroundColor Gray
        Write-Host "✓ This will trigger the update system in v2.0.0" -ForegroundColor Gray
        Write-Host "✓ All Obsidian Luxe features included" -ForegroundColor Gray
        Write-Host "✓ Complete proxy assessment functionality" -ForegroundColor Gray
        Write-Host ""
        Write-Host "Your v2.0.0 update button will now detect this new version!" -ForegroundColor Yellow
    }
    else {
