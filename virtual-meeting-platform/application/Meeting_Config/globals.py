...
hist_ini    = os.path.join(meeting_platform_vars_path,'history.ini')
meeting_platform_log  = os.path.join(log_path,'meeting_platform.log')
st_aes      = os.path.join(meeting_platform_vars_path,'st_aes.py')
st_aes_lib  = os.path.join(meeting_platform_vars_path, 'st_aes_lib.ini')
...
if not os.path.exists(meeting_platform_log):
    with open(meeting_platform_log,'w') as s: pass

st_log = logging.getLogger(meeting_platform_log)
st_log.setLevel(logging.DEBUG)
file_handler = logging.FileHandler(meeting_platform_log, 'a')
