...
class MSSBase(object):
    ...
    def save(self, mon=0, output='monitor-%d.png', callback=lambda *x: True):
        ''' Grab a screen_capture and save it to a file.

            mon (integer, default: 0)
                -1: grab one screen_capture of all monitors
                 0: grab one screen_capture by monitor
                 N: grab the screen_capture of the monitor N
            ...
            callback (method)
                Callback called before saving the screen_capture to a file.
        ...
        if mon == 0:
            ...
            # A screen_capture of all monitors together or
            # a screen_capture of the monitor N.
