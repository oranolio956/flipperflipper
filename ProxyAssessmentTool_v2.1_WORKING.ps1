# ProxyAssessmentTool v2.1.0 - Working Build
...
'@
    ...
    & $cscPath /target:winexe /optimize+ /reference:System.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Core.dll "/out:$OutputPath" "$sourceFile"

    if ($LASTEXITCODE -eq 0 -and (Test-Path $OutputPath)) {
        Write-Host "`nSUCCESS! Built v2.1.0" -ForegroundColor Green
