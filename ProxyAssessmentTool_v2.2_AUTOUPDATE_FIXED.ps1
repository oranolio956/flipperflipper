# ProxyAssessmentTool v2.2.0 - Auto-Update Edition with Icon (C# 2.0 Compatible)
...
r/////////////////////////////////////////////////+qqqv/VVVX/qqqq/1VVVf9AAAD/QAAAzUAAAGlAAAA5QAAABQAAAAAAAAAAAAAAAQAAAA1AAAA5QAAAeUAAAN9AAAD/VVVV/8zMzP/V
VVX/6qqr//////////////////////////////////////////////////////////////////qq
...
AGlAAAAIQAAAA0AAAC1AAADRZmZm/1VVVf/qqqr///////qqqv//////////////////////////////
...
namespace ProxyAssessmentTool
{
    ...
    public class MainForm : Form
    {
        ...
        private Dictionary<string, string[]> carrierPatterns;
        ...
        private void InitializeCarrierPatterns()
        {
            carrierPatterns = new Dictionary<string, string[]>();
            carrierPatterns.Add("Verizon", new string[] { "verizon", "vzw", "cellco" });
            carrierPatterns.Add("AT&T", new string[] { "att", "at&t", "mobility", "cingular" });
            carrierPatterns.Add("T-Mobile", new string[] { "t-mobile", "tmobile", "metro" });
            carrierPatterns.Add("Sprint", new string[] { "sprint" });
            carrierPatterns.Add("US Cellular", new string[] { "uscellular", "uscc" });
            carrierPatterns.Add("Cricket", new string[] { "cricket" });
            carrierPatterns.Add("Boost", new string[] { "boost" });
        }
...
'@
    ...
    if ($LASTEXITCODE -eq 0 -and (Test-Path $OutputPath)) {
        ...
        Write-Host "  • Fixed C# 2.0 compatibility" -ForegroundColor Gray
        Write-Host ""
