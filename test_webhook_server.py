...
if __name__ == '__main__':
    ...
    print("🔗 Login Page: http://localhost:5001/login")
    print("📊 Webhook Dashboard: http://localhost:5001/webhook-auth/webhook-dashboard")
    print("🏠 Dashboard: http://localhost:5001/dashboard (after login)")
    print("="*70)
